...
public class GridLines extends Component {
    ...
    public void update(float dt){
        ...
        int numVtLines = (int)(projectionSize.x / Settings.GRID_WIDTH) + 2; // vertical
        int numHzLines = (int)(projectionSize.y / Settings.GRID_HEIGHT) + 2; // horizontal
