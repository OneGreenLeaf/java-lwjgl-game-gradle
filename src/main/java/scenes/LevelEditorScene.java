...
/*
           THIS LINES OF CODES CREATE A 2 SQUARE
 */
...
//        DebugDraw.addCircle(new Vector2f(x, y), 64, new Vector3f(0, 1,0), 1); //field for create circle
//        x += 50f * dt;
//        y += 50f * dt;
    ...
    public void imgui(){
        ...
        float windowX2 = windowPos.x + windowPos.y;
